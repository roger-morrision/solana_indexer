...
export function loadConfig(env = process.env, cwd = process.cwd()) {
  ...
  return {
    ...
    ammV4PoolSnapshotFile: path.resolve(cwd, env.AMM_V4_POOL_SNAPSHOT_FILE || "data/amm-v4-pool-snapshot.json"),
    ...
    httpHeadersTimeoutMs: boundedInt(env.INDEXER_HTTP_HEADERS_TIMEOUT_MS, 10_000, 1_000, 60_000),
    ...
    maxInboxEntries: boundedInt(env.INDEXER_MAX_INBOX_ENTRIES, 100_000, 100, 1_000_000),
    ...
    webSocketMaxOutstandingAcks: boundedInt(env.INDEXER_WS_MAX_OUTSTANDING_ACKS, 1_024, 1, 10_000),
    ...
    streamIdleTimeoutMs: boundedInt(env.INDEXER_STREAM_IDLE_TIMEOUT_MS, 90_000, 1_000, 600_000),
    streamMaxMessageBytes: boundedInt(env.INDEXER_STREAM_MAX_MESSAGE_BYTES, 67_108_864, 65_536, 268_435_456),
  };
}
