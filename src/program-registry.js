export const PROGRAM_REGISTRY_VERSION = 2;
...
const programs = [
  ...
  { programId: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C", protocol: "raydium-cpmm", deploymentVersion: "mainnet", decoderVersion: 1, activationSlot: 0, eventTypes: ["swap"] },
  ...
  { programId: "pAMMBay6oceH9fJKBRHGP5D4bD4sWpmSwMn52FMfXEA", protocol: "pump-swap", deploymentVersion: "mainnet", decoderVersion: 1, activationSlot: 0, eventTypes: ["swap"] },
  { programId: "6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P", protocol: "pump-bonding-curve", deploymentVersion: "mainnet", decoderVersion: 1, activationSlot: 0, eventTypes: ["swap"] },
];
