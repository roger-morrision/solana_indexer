...
const DYNAMIC_ROUTES = [
  ...
  [/^\/internal\/(evidence)\/[^/]+$/, "/internal/$1/:id"],
  [/^\/internal\/(tokens|wallets|pools)\/[^/]+(\/[^/]+)?$/, "/internal/$1/:id$2"]
];
const STATIC_ROUTES = new Set(["/rpc", "/metrics", "/api/health", "/api/stats", "/api/trending", "/api/blocks", "/api/transactions", "/api/v1/blocks", "/api/v1/transactions", "/api/v1/swaps", "/api/v1/tokens", "/api/v1/pools", "/api/v1/bot/readiness", "/api/v1/ingestion", "/api/v1/warehouse", "/api/v1/backup", "/api/v1/recovery", "/internal/registry", "/internal/feed/health", "/internal/feed/gaps", "/internal/trending", "/internal/candidates", "/internal/new-pairs", "/internal/execution-policy"]);
