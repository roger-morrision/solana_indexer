...
export function compileWarehouseMetadataSql(state, sequence, projections = { candidates: [], security: [] }) {
  ...
  if (!Array.isArray(projections?.candidates) || !Array.isArray(projections?.security)) throw new Error("invalid warehouse projections");
