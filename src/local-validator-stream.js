...
export class LocalValidatorStream {
  constructor({ endpoint = "ws://127.0.0.1:8900", endpoints = null, rpcClient, inbox, statusFile, WebSocketClass = globalThis.WebSocket, reconnectMinMs = 500, reconnectMaxMs = 30_000, connectTimeoutMs = 10_000, expectedGenesisHash = MAINNET_GENESIS_HASH, scheduleReconnect = setTimeout, cancelReconnect = scheduleReconnect === setTimeout ? clearTimeout : () => {}, scheduleConnectTimeout = setTimeout, cancelConnectTimeout = scheduleConnectTimeout === setTimeout ? clearTimeout : () => {} }) {
    ...
    this.endpoints = configured; this.endpointIndex = 0; this.rpcClient = rpcClient; this.inbox = inbox; this.statusFile = statusFile; this.WebSocketClass = WebSocketClass; this.reconnectMinMs = reconnectMinMs; this.reconnectMaxMs = reconnectMaxMs; this.connectTimeoutMs = connectTimeoutMs; this.scheduleReconnect = scheduleReconnect; this.cancelReconnect = cancelReconnect; this.scheduleConnectTimeout = scheduleConnectTimeout; this.cancelConnectTimeout = cancelConnectTimeout;
    this.expectedGenesisHash = expectedGenesisHash; this.genesisHash = null; this.socket = null; this.stopped = false; this.reconnectMs = reconnectMinMs; this.reconnectTimer = null; this.connectTimer = null; this.subscriptions = new Map(); this.lastSlots = { confirmed: null, finalized: null }; this.durableSkippedSlots = []; this.messageQueue = Promise.resolve(); this.lastError = null; this.metrics = { connections: 0, reconnects: 0, notifications: 0, gapRepairs: 0, decodeErrors: 0, skippedSlots: [] };
  }
