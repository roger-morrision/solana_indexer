...
function validClmmBitmapExtension(extension, pool) { return extension?.pool === pool && typeof extension.address === "string" && Boolean(extension.address) && extension.segmentBits === 512 && Array.isArray(extension.positiveBitmapSegments) && extension.positiveBitmapSegments.length === 14 && extension.positiveBitmapSegments.every((value) => /^[0-9a-f]{128}$/.test(value)) && Array.isArray(extension.negativeBitmapSegments) && extension.negativeBitmapSegments.length === 14 && extension.negativeBitmapSegments.every((value) => /^[0-9a-f]{128}$/.test(value)) && /^[0-9a-f]{64}$/.test(extension.rawPayloadHash); }
