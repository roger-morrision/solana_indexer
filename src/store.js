...
export class IndexStore {
  ...
  rebuildAggregates() {
    ...
    for (const event of this.state.programEvents) if (["pool_created", "pool_migrated"].includes(event.type) && event.pool) this.state.pools[event.pool] = mergePoolLifecycle(this.state.pools[event.pool], event);
