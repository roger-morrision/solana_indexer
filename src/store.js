...
function poolLifecycleProjection(event) { return { protocol: event.protocol, venueType: "amm", baseMint: event.tokenMint0, quoteMint: event.tokenMint1, pairIdentitySource: "protocol_instruction", lifecycle: { type: event.type, slot: event.slot, blockTime: event.blockTime, signature: event.signature, creator: event.creator, ammConfig: event.ammConfig ?? null, lpMint: event.lpMint, tokenVault0: event.tokenVault0, tokenVault1: event.tokenVault1, observationKey: event.observationKey ?? null, poolIndex: event.poolIndex ?? null, initialAmount0Raw: event.initialAmount0Raw, initialAmount1Raw: event.initialAmount1Raw, requestedOpenTime: event.requestedOpenTime ?? null, coinCreator: event.coinCreator ?? null, mayhemMode: event.mayhemMode ?? null, cashbackCoin: event.cashbackCoin ?? null } }; }
