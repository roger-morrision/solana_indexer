...
| Trending page | rolling token activity rank | successful SPL transfers and verified Raydium CPMM/CLMM, Orca Whirlpools, Meteora DLMM, Phoenix orderbook, PumpSwap and Pump bonding-curve trades | 5m/1h/6h/24h swap, buy/sell, unique-trader and transfer counts; future-dated activity excluded | no USD volume or holder claim; Meteora and Phoenix event activity is not execution-liquidity evidence | `GET /api/trending` | window boundary, future-clock-skew exclusion, deterministic ranking and protocol decoder tests |
