...
| AI trading bot | execution decision inputs | Raydium CPMM swap and reserve evidence | exact execution-price ratio, pool/mints, pre-swap reserves; risk evidence absent | fail-closed capability and health gate | swaps, pools, readiness | decoder, pool and readiness tests |
