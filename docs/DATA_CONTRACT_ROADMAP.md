...
AMM v4 OpenBook reserve reconciliation is complete: the exact legacy 3,228-byte account layout, market/authority/flags, free/total balances, and finalized component slots are checked before publishing vault-plus-orders-minus-pending-PnL reserves. Executable AMM v4 quote math remains fail-closed pending fixture-verified fee and rounding semantics.
