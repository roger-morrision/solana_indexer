...
| Trending page | token activity rank | successful SPL transfers and verified Raydium CPMM, PumpSwap and Pump bonding-curve trades | mint, swap/transfer counts, last slot/time | no USD volume or holder claim | `GET /api/trending` | deterministic ranking and protocol decoder tests |
