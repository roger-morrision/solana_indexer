...
| Dead letters/checkpoints/reorg corrections | complete in compatibility store | bounded persisted evidence, REST health, and dry-run-first fingerprint-gated raw inbox retention | automated archive receipts and operational retry commands |
