...
| Dead letters/checkpoints/reorg corrections | complete in compatibility store | bounded persisted evidence, exact-fingerprint resolution/reopen lifecycle, REST health, and archive-receipt/checkpoint-gated raw inbox retention | operational retry command and durable database sink |
