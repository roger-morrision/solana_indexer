...
| Protocol swaps | partial | fixture-backed Raydium CPMM/CLMM, PumpSwap, Pump bonding curve; CLMM preserves exact sqrt price/liquidity/tick and explicitly unavailable reserves | remaining registry entries, CLMM account/tick-array state and fixture-backed decoders |
