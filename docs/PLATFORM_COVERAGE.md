...
| Protocol swaps | partial | fixture-backed Raydium CPMM/CLMM, PumpSwap, Pump bonding curve; finalized CLMM PoolState header and vault-balance snapshots preserve exact context slots | remaining registry entries, CLMM tick-array state and fixture-backed decoders |
