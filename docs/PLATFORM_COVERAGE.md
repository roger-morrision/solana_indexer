...
| Protocol swaps | partial | fixture-backed Raydium CPMM/CLMM, PumpSwap, Pump bonding curve; finalized CLMM PoolState, vault-balance, and pool-bound TickArrayState header snapshots preserve exact context slots | initialized tick bodies, bitmap coverage, remaining registry entries and fixture-backed decoders |
