...
| Protocol swaps/lifecycle | partial | fixture-backed Raydium CPMM/CLMM, PumpSwap, Pump bonding curve; successful Raydium CPMM and PumpSwap initialization instructions persist canonical pool/mint/vault/initial-deposit lifecycle evidence, including Pump pool index, creator and mode flags; finalized CLMM PoolState/vault/TickArrayState snapshots include default and verified signed overflow bitmaps with exact initialized ticks | remaining lifecycle events, registry entries and fixture-backed decoders |
