...
| Protocol swaps | partial | fixture-backed Raydium CPMM/CLMM, PumpSwap, Pump bonding curve; finalized CLMM PoolState, vault-balance, and pool-bound TickArrayState snapshots preserve exact context slots and exact initialized-tick liquidity/growth fields | bitmap coverage, remaining registry entries and fixture-backed decoders |
