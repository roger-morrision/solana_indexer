...
Version-10 PostgreSQL reconciliation independently hashes each retained canonical
preimage and verifies that its parsed JSON equals the stored token, pool, or
candidate fields, rather than trusting a mutable hash column.
