...
| Protocol swaps | partial | fixture-backed Raydium CPMM/CLMM, PumpSwap, Pump bonding curve; finalized CLMM PoolState/vault/TickArrayState snapshots include the default 1024-bit initialized-array bitmap and exact initialized-tick liquidity/growth fields | overflow bitmap-extension account, remaining registry entries and fixture-backed decoders |
