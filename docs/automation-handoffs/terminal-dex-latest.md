...
|---|---|---|---|---|---|
| UPSTREAM-QA-METEORA-PREPARATION-RECEIPT-002 | Prevent cross-quote simulation; Meteora helper | simulation lacks binder call; QC reproduction | P0; receipt binder ready; internal rejection tightening | Changed receipt plus recomputed hash rejects before RPC; focused substitution matrix | Selected |
