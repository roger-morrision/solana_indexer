...
echo "RECOVERY_STATE_ROOT='$state_root' RECOVERY_TARGET_MARKER='$marker' INDEXER_DATA_FILE='$state_root/data/index.json' INDEXER_INBOX='$state_root/inbox' EXPORTER_STATUS_FILE='$state_root/data/exporter-status.json' ACCOUNT_SNAPSHOT_FILE='$state_root/data/account-snapshot.json' INDEXER_WAREHOUSE_CHECKPOINT_FILE='$state_root/data/warehouse-checkpoint.json' npm run validate:recovery -- '$source_dir' '$restore_started_at' '/absolute/recovery-report.json'"
