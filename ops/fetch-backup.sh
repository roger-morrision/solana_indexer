...
files=(postgres.dump clickhouse-instructions.native clickhouse-swaps.native clickhouse-balance_changes.native clickhouse-dead_letters.native redis.rdb indexer-state.tar inbox-manifest.json manifest.json SHA256SUMS)
